...
const DocForm = ({ kind, initialHeader, initialItems, onSubmit, submitting, title }: Props) => {
  ...
  return (
    <div>
      ...
      <div className="bg-card rounded-xl border border-border p-6 mb-4 grid grid-cols-1 md:grid-cols-4 gap-3">
        <div>
        ...
        <div>
          <label className="text-xs font-semibold text-muted-foreground uppercase mb-1 block">Date</label>
