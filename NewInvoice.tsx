  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-3xl font-black text-foreground tracking-tight">All Invoices</h1>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {rows.map(r => {
                ...
                return (
                  <tr key={r.id} className="border-t border-border/50 hover:bg-muted/30 transition">
